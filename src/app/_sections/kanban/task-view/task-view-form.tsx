...
export function TaskViewForm() {
	...
	return (
	  <form onSubmit={handleSubmit(onSubmit)}>
			<Input
				name="title"
				className="h-auto flex pl-2  hover:border-input   focus:ring-1 ring-white border-transparent"
...
export const SearchInput = () => {
	return (
		<div className="relative" >
			<Search size={15} className="absolute left-2 top-1/2  transform -translate-y-1/2" />
